...
namespace Sandbox461.Website.Controllers
{
    public partial class HomeController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult UploadAjax()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UploadAjax);
        }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string UploadAjax = "UploadAjax";
        }
        ...
        public class ActionNameConstants
        {
            ...
            public const string UploadAjax = "UploadAjax";
        }


        static readonly ActionParamsClass_UploadAjax s_params_UploadAjax = new ActionParamsClass_UploadAjax();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_UploadAjax UploadAjaxParams { get { return s_params_UploadAjax; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_UploadAjax
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Upload = "~/Views/Home/Upload.cshtml";
            public readonly string View = "~/Views/Home/View.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Sandbox461.Website.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void UploadAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Collections.Generic.List<System.Web.HttpPostedFileBase> files);

        [NonAction]
        public override System.Web.Mvc.ActionResult UploadAjax(System.Collections.Generic.List<System.Web.HttpPostedFileBase> files)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UploadAjax);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "files", files);
            UploadAjaxOverride(callInfo, files);
            return callInfo;
        }
